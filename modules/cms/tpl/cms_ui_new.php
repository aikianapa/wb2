...
<html lang="en">
  <head>
	...
	<!-- Bootstrap extend-->
	<link rel="stylesheet" href="{{_var.base}}/css/bootstrap-extend.css">

	<!-- theme style -->
	<link rel="stylesheet" href="{{_var.base}}/css/master_style.css">

	<!-- Fab Admin skins -->
	<link rel="stylesheet" href="{{_var.base}}/css/skins/_all-skins.css">
...
<body class="cms hold-transition skin-blue sidebar-mini fixed">
<div class="wrapper">
...
<script type="wbapp">
    wbapp.loadScripts([
      "{{_var.base}}/../assets/vendor_components/jquery-slimscroll/jquery.slimscroll.js",
      "{{_var.base}}/../assets/vendor_components/popper/dist/popper.min.js",
      "{{_var.base}}/../assets/vendor_components/fastclick/lib/fastclick.js",
      "{{_var.base}}/../assets/vendor_components/jquery.peity/jquery.peity.js",
      "{{_var.base}}/js/template.js",
//      "{{_var.base}}/js/pages/dashboard.js",
...
<script type="wbapp">
  $(document).on("cms-js",function(){
	...
	<script src="{{_var.base}}/js/demo.js!!!!"></script>
